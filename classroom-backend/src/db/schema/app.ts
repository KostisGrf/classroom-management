...
const timestamps = {
    ...
    updated_at:timestamp('updated_at').notNull().defaultNow().$onUpdate(()=>new Date()).notNull()
}
...
export const enrollments = pgTable('enrollments', {
  ...
  uniqueEnrollment: unique('enrollments_student_class_unique').on(table.studentId, table.classId)
}));
